const DragonBallCard = ({ character }) => {
  return (
    ...
    >
      <div className="flex h-72 items-center justify-center rounded-b-2x1 bg-[radial-gradient(circle_at_20%_20%,rgba(255,248,216,0.95),rgba(237,243,255,0.78)_75%)]">
        <img
          className="h-full w-full rounded-2x1 object-contain transition-all duration-300"
          src={character.image}
          alt={character.name}
          loading="lazy"
          onError={(event) => {
